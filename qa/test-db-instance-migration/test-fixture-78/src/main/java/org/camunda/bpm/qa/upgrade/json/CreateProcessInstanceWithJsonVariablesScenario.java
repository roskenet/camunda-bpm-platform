...
public class CreateProcessInstanceWithJsonVariablesScenario {
  ...
  public static ScenarioSetup initProcessInstance() {
    return new ScenarioSetup() {
      public void execute(ProcessEngine engine, String scenarioName) {
        ...
        engine.getRuntimeService().setVariable(execution.getId(), "objectArrayVariable", createObjectArray());
  ...
  public static Object[] createObjectArray() {
    Object[] customersArray = new Object[2];
    customersArray[0] = new RegularCustomer("someCustomer", 5);
    customersArray[1] = new SpecialCustomer("specialCustomer", 666);
  ...
  public static ObjectList createNotGenericObjectList() {
    ...
    customers.add(new SpecialCustomer("specialCustomer", 666));
    return customers;
  }
